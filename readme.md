![Terraform AWS Module - Create VPN Connection](https://github.frapsoft.com/top/open-source-v1.png)

# Terraform AWS Module - Create VPN Connection
...
module "aws_vpn_connection" {
  source = "./modules/tf-aws-vpn-connection"

  vpn_gateway_id      = "YOUR_VPN_ID_HERE"
  customer_gateway_id = "YOUR_CUSTOMER_ID_HERE"
  type                = "ipsec.1"
